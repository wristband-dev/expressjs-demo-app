...
const touchSessionCookieHandler = require('../middleware/touch-session-cookie-handler');
...
router.use('/v1', [accessTokenHandler, touchSessionCookieHandler, csrfTokenCookieHandler], apiRoutes);
